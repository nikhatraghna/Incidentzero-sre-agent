...
|---|---|---|---|---|---|---|---|---|---|---|
| i25-8029_public-a | escalated | 14 (plan_create=1, decide=12, plan_revision=1) | 9 (controller=3) | 2 (scale_service, escalate_incident) | 2 (approval_denied, budget_low) | 1 / 0a-1d / 0 | EV-0008 criteria_met=False; close=not called | 1 repeated reads, 0 rejected | 101.25s wall / 36.366s agent (approval wait 64.9s) | 19701 |
| i25-8029_public-b | resolved | 14 (plan_create=1, decide=13) | 7 (controller=3) | 2 (restart_service, close_incident) | 1 (budget_low) | 0 / 0a-0d / 0 | EV-0006 criteria_met=True; close=ok | 0 repeated reads, 0 rejected | 65.263s wall / 65.263s agent (approval wait 0.0s) | 8725 |
| i25-8029_public-c | resolved | 14 (plan_create=2, decide=12) | 7 (controller=2) | 2 (clear_cache, close_incident) | 1 (budget_low) | 0 / 0a-0d / 0 | EV-0006 criteria_met=True; close=ok | 0 repeated reads, 0 rejected | 55.666s wall / 55.666s agent (approval wait 0.0s) | 10918 |
<!-- EVAL-TABLE:END -->
